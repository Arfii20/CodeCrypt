...
public class CodeCrypt extends Application {
    ...
    public void start(Stage stage) throws IOException {
        this.window = stage;
        FXMLLoader primaryXML = new FXMLLoader(CodeCrypt.class.getResource("hello-view.fxml"));
        FXMLLoader EncryptDecryptXML = new FXMLLoader(CodeCrypt.class.getResource("Encrypt_or_Decrypt.fxml"));
        FXMLLoader encryptFirstXML = new FXMLLoader(CodeCrypt.class.getResource("Encrypt_Customise.fxml"));
        FXMLLoader decryptFirstXML = new FXMLLoader(CodeCrypt.class.getResource("Decrypt_Customise.fxml"));
        FXMLLoader encryptValueXML = new FXMLLoader(CodeCrypt.class.getResource("EnterValueEncrypt.fxml"));
        FXMLLoader decryptValueXML = new FXMLLoader(CodeCrypt.class.getResource("EnterValueDecrypt.fxml"));
        FXMLLoader encryptFinalXML = new FXMLLoader(CodeCrypt.class.getResource("Encrypt_page.fxml"));
        FXMLLoader decryptFinalXML = new FXMLLoader(CodeCrypt.class.getResource("Decrypt_page.fxml"));
        FXMLLoader ThankYouXML = new FXMLLoader(CodeCrypt.class.getResource("ThankYouPage.fxml"));
